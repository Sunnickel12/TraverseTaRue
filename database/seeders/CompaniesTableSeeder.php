...
class CompaniesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('companies')->insert([
            ...
            [ 'name' => 'TechNova', 'city' => 'Paris', 'address' => '123 Rue des Inno', 'description' => 'Entreprise spécialisée en intelligence artificielle et cloud computing.', 'logo' => 'logo_technova.jpg'],
            ...
            [ 'name' => 'CyberSecure', 'city' => 'Toulouse', 'address' => '89 Rue de la Sécurité', 'description' => 'Entreprise de cybersécurité et protection des données.', 'logo' => 'logo_cybersecure.avif'],
            ...
            ['name' => 'AutoSoft', 'city' => 'Toulouse', 'address' => '23 Rue des Algorithmes', 'description' => 'Développement de logiciels pour l’industrie automobile.', 'logo' => 'logo_autosoft.jpg'],
            ...
            ['name' => 'BioTech Solutions', 'city' => 'Montpellier', 'address' => '22 Boulevard des Sciences', 'description' => 'Innovations en biotechnologie et recherche pharmaceutique.', 'logo' => 'logo_biotech_.avif'],
            ...
            [ 'name' => 'GameDev Studio', 'city' => 'Metz', 'address' => '11 Avenue du Jeu', 'description' => 'Développement de jeux vidéo et applications interactives.', 'logo' => 'logo_gamedev.jpg']
        ]);
    }
}
