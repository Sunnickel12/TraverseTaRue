<nav class="bg-[#3a3a3a] local-font-gliker shadow-md py-3 rounded-b-3xl relative w-screen">
...
<!-- Pop-up de connexion -->
<div id="login-popup" class="local-font-gliker fixed top-0 w-full h-full flex justify-center items-center hidden z-100">
    <div class="bg-black opacity-50 absolute inset-0"></div>
    <div
        class="bg-white w-[90%] md:w-[500px] max-h-[90vh] p-6 md:p-10 rounded-lg shadow-xl z-10 relative overflow-y-auto">
        <form>
            <div class="mb-6">
                <label for="email"
                    class="block text-2xl md:text-4xl text-center font-medium text-[#6e9ae6] mb-4">Identifiant</label>
            ...
            <div class="mb-6">
                <label for="password" class="block text-xl md:text-3xl text-center font-medium text-[#6e9ae6] mb-2">Mot
                    de passe</label>
                <div class="relative">
            ...
            <div class="flex items-center mb-4">
                <input type="checkbox" id="remember-me" class="w-6 h-6 border-2 border-[#3a3a3a] rounded-sm checked:bg-[#6e9ae6] focus:outline-none">
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="#" class="text-sm md:text-base ml-1.5 text-[#6e9ae6] hover:underline">Mot de passe oublié
                    ?</a>
            </div>
        </form>
