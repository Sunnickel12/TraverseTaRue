<nav class="bg-[#3a3a3a] local-font-gliker shadow-md py-3 rounded-b-lg">
    ...
    <div id="mobile-menu"
        class="md:hidden fixed top-0 left-0 w-48 h-full bg-[#2d2d2d] transform -translate-x-full transition-all duration-300 ease-in-out z-20">
...
<!-- Pop-up de connexion agrandie et ajustée -->
<div id="login-popup"
    class="local-font-gliker fixed top-0 left-0 w-full h-full flex justify-center items-center hidden z-30">
    ...
    <div class="bg-white w-[500px] max-h-[90vh] p-10 rounded-lg shadow-xl z-10 relative overflow-y-auto">
        <form>
            <div class="mb-6">
                ...
                <input type="email" id="email" name="email" placeholder="Entrez votre email"
                    class="w-full p-4 text-lg border-2 border-[#3a3a3a] rounded-md focus:border-[#6e9ae6] focus:ring-2 focus:ring-[#6e9ae6] focus:outline-none transition-all duration-300"
                    required>
            </div>
            <div class="relative w-full mb-6">
                <label for="password" class="block text-4xl text-center font-medium text-[#6e9ae6] mb-4">Mot de
                    passe</label>
                <div class="relative flex items-center">
                    <input type="password" id="password" name="password" placeholder="Mot de passe"
                        class="w-full p-4 pr-12 text-lg border-2 border-[#3a3a3a] rounded-md focus:border-[#6e9ae6] focus:ring-2 focus:ring-[#6e9ae6] focus:outline-none transition-all duration-300"
                        required>
                    <img id="toggle-password-icon" src="{{ asset('images/eye-closed.png') }}"
                        alt="Afficher/Masquer le mot de passe"
                        class="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer w-7 h-7 pointer-events-auto" />
                </div>
            </div>
            <div class="flex items-center mb-6">
                <input type="checkbox" id="remember-me"
                class="w-5 h-5 text-[#6e9ae6] border-2 border-[#3a3a3a] rounded focus:ring-[#6e9ae6]">
                <label for="remember-me" class="ml-3 text-base text-[#3a3a3a]">Se souvenir de moi</label>
            </div>
            <div class="flex justify-between items-center">
                <button type="submit"
                    class="bg-[#6e9ae6] text-white text-lg py-3 px-10 rounded-md hover:bg-[#5a85d1] transform hover:scale-105 transition-all duration-300">
                    Se connecter
                </button>
        ...
        <button id="close-login-popup"
            class="absolute top-4 right-4 text-4xl text-gray-600 hover:text-[#6e9ae6] transition-all duration-200 transform hover:scale-110">&times;</button>
    </div>
</div>
