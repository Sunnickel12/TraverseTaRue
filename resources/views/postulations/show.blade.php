...
<div class="container mx-auto mt-8">
    ...
    <!-- Check if the user is authorized to view the postulation -->
    <div class="bg-white shadow-md rounded-lg p-6">
        <!-- Display postulation details -->
        ...
        <div class="mt-4">
            ...
            <ul>
                <!-- Display CV download link if available -->
                <li>
                    <strong>CV:</strong>
                    @if($postulation->cv)
                ...
                <!-- Display motivation letter download link if available -->
        ...
        <!-- Admin-only section to modify the postulation status -->
        <div class="mt-6">
